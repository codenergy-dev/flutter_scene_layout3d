...
///
/// This library is the token layer and the theme that carries it:
/// [ColorScheme3d], [Typography3d], [ShapeScale3d], [Elevation3d] and
/// [Thickness3d], held by a [Theme3dData], installed by [SceneTheme3d] and
/// read by `Theme3d.of(context)` in the widget layer or `theme3d` inside a
/// `Layout3d`'s `performLayout`.
///
/// ```dart
/// SceneLayout3d(
...
///
/// **Nothing in this package draws until an application installs a panel
/// painter.** `BoxDecoration3d.painterFactory` is null until something sets
/// it, so a themed component measures, lays out and shows nothing. The
/// package README says how; the shader itself is compiled for you by
/// `flutter_scene_layout3d`'s own build hook, and this package deliberately
/// ships no build hook of its own.
library;
...
export 'src/tokens/typography.dart' show Typography3d;
